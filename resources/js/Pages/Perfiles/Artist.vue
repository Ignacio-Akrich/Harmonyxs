                ...
                <div class="row">
                    <div class="col-12 col-md-8">
                        ...
                        <div class="inf-art border border-3 mb-2 bg-white shadow py-3">
                            ...
                            <!-- Datos Artista -->
                            <div class="ms-5" v-if="$page.props.user.instrumento !== null">
                                <p>Instrumento principal</p>
                                <p><b>{{$page.props.user.instrumento}}:</b> {{$page.props.user.experience}}</p>
                            </div>
                            <hr class="mx-4" v-if="$page.props.user.instrumento !== null">
                            <p class="ms-5" v-if="$page.props.user.band_experience !== null"><b>Experiencia con bandas: </b>
                                <span v-if="$page.props.user.band_experience == '1'">Si</span> 
                                <span v-if="$page.props.user.band_experience == '0'">No</span>
                            </p>
                            <hr class="mx-4" v-if="$page.props.user.band_experience !== null">
                            <p class="ms-5" v-if="$page.props.user.age !== null"><b>Edad: </b>{{$page.props.user.age}}</p>
                            <hr class="mx-4" v-if="$page.props.user.age !== null">    
                            <p class="ms-5" v-if="$page.props.user.gender !== null && $page.props.user.gender !== 'none'"><b>Genero: </b>{{$page.props.user.gender}}</p>
                            <hr class="mx-4" v-if="$page.props.user.gender !== null && $page.props.user.gender !== 'none'">
                        </div>
                        <div class="disp-art border border-3 mb-2 bg-white shadow py-3">
                                    ...
                                    <div class="col-sm-9 d-flex">
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div>                                    
                                                    <div>
                                                        <Link class="iconbutton-dark mx-2" :href="route('misanuncios.edit', anuncio.id)" customtip="Editar">
                            ...
                            <div class="d-flex justify-content-center">
                                <Link v-if="$page.props.user" class="px-4 py-2 mb-2 btn btn-dark" :href="route('misanuncios.create')" as="button">
                                    Crear nuevo anuncio
                                </Link>
                            </div>
                        </div>
